...
if (window.location.href.includes("pchat")) site = "pchat2";
else if (window.location.href.includes("schat")) site = "schat2";
    ...
    try {
        ...
        if (messages.length > lastMsgCount) {
            ...
            for (let i = lastMsgCount; i < messages.length; i++) {
                ...
                const alignRight = (site === 'pchat2' && senderLower === 'anonymous') || (site === 'schat' && senderLower === 'josh');
